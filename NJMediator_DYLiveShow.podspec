#
# Be sure to run `pod lib lint NJMediator_DYLiveShow.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NJMediator_DYLiveShow.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'NJMediator_DYLiveShow' => ['NJMediator_DYLiveShow/Assets/*.png']
  # }
